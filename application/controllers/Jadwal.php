...
class Jadwal extends CI_Controller
{
	...
	public function tambah()
	{
		...
		$this->form_validation->set_rules('jam_mulai1','Jam Mulai', 'required');
		$this->form_validation->set_rules('jam_akhir1','Jam Akhir', 'required');
		$this->form_validation->set_rules('id_mengajar1','Rombel - Mata Pelajaran', 'required');
		$this->form_validation->set_rules('id_ruangan1','Ruangan', 'required');
